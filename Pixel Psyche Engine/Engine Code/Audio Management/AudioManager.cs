...
//-----------------------------------------------------------------------------
// AudioManager.cs
// Matt McGrath, with knowledge borrowed from XNA community tutorials.
//-----------------------------------------------------------------------------
#endregion
...
namespace PixelEngine.Audio
{
     ...
     public class AudioManager : GameComponent
     {
          ...
          private static AudioCategory musicAudioCategory;
          private static AudioCategory soundAudioCategory;
          ...
          /// <summary>
          /// Whether or not Music is Enabled (allowed to play).
          /// </summary>
          ...
          /// <summary>
          /// The AudioCategory which all Music cues belong to.
          /// </summary>
          public static AudioCategory MusicAudioCategory
          {
               get { return musicAudioCategory; }
               set { musicAudioCategory = value; }
          }

          /// <summary>
          /// The AudioCategory which all Sound cues belong to.
          /// </summary>
          public static AudioCategory SoundAudioCategory
          {
               get { return soundAudioCategory; }
               set { soundAudioCategory = value; }
          }
               ...
               : base(game)
          {
               ...
               soundAudioCategory = audioEngine.GetCategory("Sound");
          }
