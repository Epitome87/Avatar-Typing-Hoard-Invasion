...
{
     /// <summary>
     /// Helper class. Makes working with Keys easier by providing 
     /// frequently-used Keys-related methods.
     /// 
     /// **** LOOKS LIKE I'VE ONLY USED THIS FOR TYPINGKEYS.ISSHIFTREQUIRED()
     /// </summary>
     public class KeysHelper
     {
          #region Public IsShiftRequired Method

          /// <summary>
          /// Returns True if the Shift key is required in forming the specified character.
          /// 
          /// For example, typing a "?" requires the shift key in conjunction with the "/" key.
          /// </summary>
          /// <param name="character">The character to query if a Shift is required for.</param>
          /// <returns>True if Shift required, False if not.</returns>
          public static bool IsShiftRequired(char character)
          {
               switch (character)
               {
                    case '"':
          ...
          #region Public Translate Methods
