...
namespace PixelEngine.DebugUtilities.SafeArea
{
    /// <summary>
    ...
    public class SafeAreaOverlay : DrawableGameComponent
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Rectangle horizontalCenter = new Rectangle(0, (int)centerScreen.Y, viewport.Width, 1);
            Rectangle verticalCenter = new Rectangle((int)centerScreen.X, 0, 1, viewport.Height);

            spriteBatch.Draw(dummyTexture, horizontalCenter, Color.DarkGreen);
            spriteBatch.Draw(dummyTexture, verticalCenter, Color.DarkGreen);
